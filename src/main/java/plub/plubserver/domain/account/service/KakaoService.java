...
public class KakaoService {
    ...
    protected boolean revokeKakao(String userId) {
        ...
        ResponseEntity<AuthDto.RevokeKakaoResponse> response = restTemplate.postForEntity("https://kapi.kakao.com/v1/user/unlink", httpEntity, AuthDto.RevokeKakaoResponse.class);
